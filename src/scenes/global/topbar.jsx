    ...
    <Dialog open={settingsDialogOpen} onClose={handleClose}>
      ...
      >
        ...
        >
          ...
          <Typography
            variant="h3"
            sx={{ color: `${colors.yellow[500]}`, fontWeight: "700" }}
          >
            V1.1
          </Typography>
        </div>
        ...
        <AccordionComponent
          ...
          children={<GeneralSettingsInsertPart />}
        />
        <AccordionComponent
          title="Factor Group"
          children={<FactorGroupInsertPart />}
        />
        <AccordionComponent
...
const FactorGroupInsertPart = () => {
  ...
  return (
    <section style={{ padding: "1rem" }}>
      <li>
        Select "Applied Factor Group" only when it's enabled in the drive as
        well.
      </li>
    ...
    <section>
      {sidebarSelectedItem == "Decode LOG" ? (
        ...
        >
          ...
          <p style={{ color: `${colors.blue[400]}`, fontWeight: "700" }}>
            {ProtocolGlobal}
          </p>
        </section>
      ) : null}
    ...
    return (
      ...
      >
        ...
        <p
          style={{
            color: `${
              (31 - index) % 4 == 0 ? colors.green[400] : "transparent"
            }`,
            justifyContent: "center",
            fontSize: "0.5rem",
          }}
      ...
      {CalcVsRegister == "Calculator" ? (
        <section>
          ...
          >
            <Typography
              variant="h5"
              sx={{ mb: "1rem", color: `${colors.grey[100]}` }}
            >
              Calculator Programmer
            </Typography>
            <section
    ...
    const handleKeyPress = (event) => {
      if (
        ...
        if (pass == 418548904545) {
          ...
          pass == 27988495321099876 ||
          pass == 8319385953830004000 ||
          pass == 1952804208
        ) {
          setClearance(44);
          setLevel(4);
